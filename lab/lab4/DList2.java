...
public class DList2 {
	 ...
	 * x.next != null. 3) For any DListNode2 x in a DList2, x.prev != null. 4) For
	 * any DListNode2 x in a DList2, if x.next == y, then y.prev == x. 5) For any
	 * DListNode2 x in a DList2, if x.prev == y, then y.next == x. 6) size is the
	 * number of DListNode2s, NOT COUNTING the sentinel (denoted by "head"), that
