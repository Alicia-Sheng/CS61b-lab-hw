...
public class DList1 {
	 ...
	 * DListNode1 x in a DList, if x.next == y and x.next != null, then y.prev == x.
	 * 4) For any DListNode1 x in a DList, if x.prev == y and x.prev != null, then
	 * y.next == x. 5) The tail can be accessed from the head by a sequence of
	 * "next" references. 6) size is the number of DListNode1s that can be accessed
	 * from the head by a sequence of "next" references.
	 */
	...
	/**
	 * removeFront() removes the first item (and node) from a DList1. If the list is
	 * empty, do nothing.
	 */
